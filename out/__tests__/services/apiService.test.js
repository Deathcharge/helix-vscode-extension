...
describe('ApiService', () => {
    ...
    describe('authentication methods', () => {
        ...
        it('should handle authentication failure', async () => {
            ...
            expect(errorHandler_1.errorHandler.handleApiError).toHaveBeenCalled();
        });
        it('should refresh token successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/auth/refresh', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
    ...
    describe('agent methods', () => {
        it('should get agents successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/agents/list', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should get agent status successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/agents/agents/agent-1', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should execute agent task successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/agents/collaboration/run', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
    ...
    describe('coordination methods', () => {
        it('should get coordination metrics successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/coordination/metrics', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should get coordination alerts successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/coordination/alerts', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
    ...
    describe('marketplace methods', () => {
        it('should browse products successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/marketplace/products', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should browse products by category', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/marketplace/products?category=agent', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should install product successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/marketplace/products/product-1/install', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
    ...
    describe('workflow methods', () => {
        it('should create workflow successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/spirals', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
        ...
        it('should execute workflow successfully', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/spirals/workflow-1/execute', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'User-Agent': 'Helix-VSCode-Extension/1.0.0',
    ...
    describe('error handling', () => {
        ...
        it('should handle HTTP errors', async () => {
            ...
            await expect(apiService.getAgents()).rejects.toThrow('API request failed: 500 Internal Server Error');
            expect(errorHandler_1.errorHandler.handleApiError).toHaveBeenCalled();
        });
    });
